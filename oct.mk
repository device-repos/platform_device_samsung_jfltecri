...
PRODUCT_BUILD_PROP_OVERRIDES += PRODUCT_NAME=jfltecri TARGET_DEVICE=jfltecri BUILD_FINGERPRINT="samsung/oct_jfltecri/jfltecri:4.4/KRT16S/user/release-keys" PRIVATE_BUILD_DESC="jfltecri-user 4.4 KRT16S release-keys"
